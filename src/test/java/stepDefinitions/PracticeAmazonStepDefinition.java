...
public class PracticeAmazonStepDefinition {
    ...
    public void there_was_a_problem_mesajini_dogrular() {
        ...
        Assert.assertEquals("Different Message!",expectedText,actualText);
    }
    @Then("Need help e tiklar")
    public void need_help_e_tiklar() {
        practiceAmazonPage.needHelpLink.click();
    }
    ...
    public void create_account_metnini_dogrular() {
        Assert.assertTrue("Create Account Text Icermiyor",
                practiceAmazonPage.createAccountText.getText().contains("Create account"));
    }
